  ...
  return (
    <main className="min-h-dvh grid place-items-center px-5 py-10">
      <div className="w-full max-w-sm">
        ...
        {/* The passwords are generated by the seed and printed to its console,
            so there is nothing to show here - only where to find them. */}
        <p className="mt-6 text-xs text-center text-[var(--color-slate-soft)] leading-relaxed">
          Accounts: <code className="text-[var(--color-paper-dim)]">student</code> and{' '}
          <code className="text-[var(--color-paper-dim)]">parent</code>. Their passwords are
          printed once by <code className="text-[var(--color-paper-dim)]">npm run seed</code>.
          <br />
